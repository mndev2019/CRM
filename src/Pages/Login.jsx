...
const Login = () => {
  ...
  return (
    <section className="h-screen grid grid-cols-2 overflow-hidden">
      ...
      <div className="flex flex-col justify-center px-20 bg-white">
        ...
        <form className="space-y-6">
          ...
          {/* Button */}
          <button onClick={()=> navigate('/profile')} className="w-full bg-gray-800 text-white py-2 rounded-md hover:bg-black duration-200">
            Continue
          </button>
        </form>
    ...
    background: "linear-gradient(to bottom, #444A60 15%, #5C6290 91%)",
  }}>
        <img
