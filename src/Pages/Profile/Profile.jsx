      ...
      <section className="px-4 sm:px-6 md:px-10 py-6 sm:py-8 bg-white rounded-bl-2xl rounded-br-2xl">
        ...
        <div className="flex justify-between items-center flex-wrap gap-4">
          <div className="flex items-center gap-6 flex-wrap">
            ...
            <div className="relative">
              <img
                src={userIcon}
                alt="User Avatar"
                className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full object-cover shadow"
              />

              <button
                onClick={() => setshoweditpopup(!showeditpopup)}
                className="absolute bottom-[-3px] right-2 bg-white shadow-md h-6 w-6 rounded-full flex items-center justify-center"
              >
                <RiEdit2Fill className="text-[#6C4FFB] text-md" />
              </button>
              ...
              {showeditpopup && (
                <div className="
                  bg-white rounded-[12px] shadow p-3 absolute space-y-1
                  min-w-[220px] sm:min-w-[250px]
                  top-[110%] sm:top-[3px]
                  left-0 sm:left-[130px]
                  z-20
                ">
                  <div className="flex items-center gap-2">
                    <img src={edit} className="h-5" />
            ...
            <div>
              <div className="flex items-center gap-3 flex-wrap">
                <h1 className="text-xl sm:text-2xl font-bold nunito">
                  Shalini Gupta
                </h1>
                <span className="bg-white text-[#FFAC1B] text-xs font-semibold px-3 py-1 rounded-full border border-[#FFAC1B] inter">
                  Super Admin
              ...
              <span className="text-[#363636] inter flex items-center gap-2 text-sm my-1">
                User Id: 765476768
                <div className="border border-gray-300 rounded-[6px] p-1">
                  <MdOutlineContentCopy className="cursor-pointer" />
                </div>
              </span>

              <div className="flex items-center gap-8 mt-2 text-[#363636] flex-wrap">
                <span className="flex items-center gap-2 inter">
                  <FaEnvelope /> ishaxyz@gmail.com
                </span>
                <span className="flex items-center gap-2 inter">
          ...
          <button
            ...
            className="
              text-white font-semibold px-4 py-2 rounded-md cursor-pointer
              bg-[linear-gradient(180deg,#049B1D_22.26%,#01582C_100%)]
              w-full sm:w-auto
            "
          >
        ...
        {/* Info Table */}
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-20 text-sm">
          <p className="text-gray-500 inter text-[16px]">First Name</p>
          <p className="text-[#363636] inter text-[16px]">Shalini</p>
          ...
          <p className="text-gray-500 inter text-[16px]">
            Agent Phone Number
          </p>
          <p className="text-[#363636] inter text-[16px]">8342454576</p>
        </div>
