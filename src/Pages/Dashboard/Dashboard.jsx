...
const Dashboard = () => {
    ...
    return (
        <>
            <div className='flex items-center justify-between'>
                <div>
                    <h2 className='text-[#083560] nunito font-bold text-[20px]'>
                        Hi Tannu, Welcome Back To RAMOT CRM!
                    </h2>
                </div>
                <div className='flex items-center gap-3'>
                    <button onClick={()=> navigate('/profile')} className="text-white inter font-bold text-[14px] 
                       bg-[linear-gradient(90deg,#2A75FF_0%,#4FADFF_100%)] 
                           border border-[#2A75FF] rounded-[4px] px-4 py-2">
                        View Profile
                    </button>
                    {/* <div className='bg-[#BCE2FF] text-[#2A75FF] rounded-[5px] p-2 text-lg'>
            ...
            <div className="relative overflow-hidden 
                bg-[linear-gradient(91.26deg,#00B1E3_7.78%,#19BDEB_27.61%,#77E1FF_44.14%,#19BDEB_68.53%,#00B1E3_87.12%)]
                 p-8 mt-3 rounded-[12px] flex items-center justify-between">
                ...
                <div>
                    <h2 className="text-white nunito font-bold text-[18px]">
                        Boost Setups to CRM Funnels Instantly!
                    </h2>
                    <p className="nunito font-semibold text-[16px] mt-1 text-white">
                ...
                <button
                    className="bg-[linear-gradient(90deg,#FFFFFF_0%,#DFF0FF_100%)]
                        text-[#006BAE] inter font-semibold text-[18px]
            ...
            <div className="bg-white rounded-[10px] py-5  mt-6 shadow-[2px_2px_6px_0px_#A1C1FF40]">
                <div className="flex justify-between items-center mb-4 px-5">
                    ...
                    {/* <button className="flex items-center gap-1 text-[#4C4646] text-[14px] nunito font-medium">
                        Last Week <HiChevronDown />
                    </button> */}
                </div>
 ...
 flex flex-col items-center justify-center p-6 dashbox">
            ...
            <div className='grid grid-cols-12 gap-3'>
                <div className="col-span-3 bg-white rounded-[8px] shadow-[2px_2px_6px_0px_#A1C1FF40] p-4 mt-3">
                    <h2 className='nunito font-[700] text-[16px] text-[#4C4646] mb-4'>
                        RENEWALS DUE
                    </h2>
                    <div

                        className="bg-[#F2FBFF] rounded-[6px] p-3 shadow-sm flex gap-4"
                    >
                        {/* Custom Left Indicator */}
                        ...
                        <div className="flex justify-between items-start w-full">
                            ...
                            <div>
                                ...
                                <h2 className="font-bold text-[18px] inter">
                                    10
                                </h2>
                            </div>
                    ...
                    <div
                        ...
                        className="bg-[#F2FBFF] rounded-[6px] p-3 shadow-sm flex gap-4 mt-3"
                    >
                        {/* Custom Left Indicator */}
                        <div className='flex items-center'>
                ...
                <div className="col-span-9 bg-white rounded-[8px] shadow-[2px_2px_6px_0px_#A1C1FF40] p-4 mt-3">
                    {/* Header */}
                    ...
                    <div className="grid grid-cols-12 gap-4">
                        ...
                        <div className="col-span-8 grid grid-cols-2 gap-3">
                            ...
                            {[
                                {
                                    title: "Renewals Attempted",
                                    value: 10,
                                    bar: "bg-[#90D779]",
                                },
                                {
                                    title: "Renewals Successful",
                                    value: 10,
                                    bar: "bg-[#D27FFF]",
                                },
                                {
                                ...
                                <div
                                    key={index}
                                    className={`rounded-[6px] p-3 flex gap-3 bg-[#F2FBFF] shadow-sm`}
                                >
                                    {/* Left Indicator */}
                                    <div className="flex items-center">
                                    ...
                                    <div className="flex justify-between w-full">
                                        <div>
                                            ...
                                            <h3 className="font-bold text-[18px] inter">
                                                {item.value}
                                            </h3>
                                        </div>
                        ...
                        {/* Right Card */}
                        <div className="col-span-4 bg-[linear-gradient(257.18deg,#F3FBFF_4.53%,#F6E9FF_100%)]
  flex flex-col items-center justify-center text-center p-4 border border-[#EABAFF] rounded-[6px]">
                            <div className="w-10 h-10 bg-[#F0DBFF] rounded-full flex items-center justify-center mb-2">
                                🔄
                            </div>

                            <p className="text-[15px] nunito font-bold">
                                Renewals Successful Rate
                            </p>
                            <h2 className="font-extrabold text-[18px] inter mt-1">
                                0.00%
                            </h2>
                        </div>
                    </div>
            ...
            <div className='grid grid-cols-2 gap-3'>
                <div className="col-span-1 bg-white rounded-[8px] shadow-[2px_2px_6px_0px_#A1C1FF40] p-4 mt-3">
                    <BarChart />
                </div>
                <div className="col-span-1 bg-white rounded-[8px] shadow-[2px_2px_6px_0px_#A1C1FF40] p-4 mt-3">
                    <DonutChart />
