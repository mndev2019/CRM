...
const LeadDetail = () => {
    ...
    return (
        <>
            <Topnav
                title="Client Leads"
                subtitle="View and organize every client lead added to your pipeline."
                icon={newlead}
            />
                ...
                <div className="rounded-[12px] border border-[#EDEEF4] p-3">
                    ...
                    <div className="flex justify-between py-2 border-b-2 border-[#EDEEF4]">
                        <div className="flex gap-3 items-center relative">
                            ...
                            {/* <div onClick={() => setshowactionmenu(!showactionmenu)} className="rounded-[4px] py-1 px-2 nunito border-2 border-[#EDEEF4] cursor-pointer">
                                Take Actions
                            </div>
                            {showactionmenu &&

                                <div className="bg-white absolute top-12 left-[130px] rounded-[4px] shadow z-20 w-40">
                                    <p className="nunito font-semibold text-[14px] hover:bg-[#EDEEF4] py-2 px-5 cursor-pointer">
                                        Send Email
                                    </p>
                                    <p className="nunito font-semibold text-[14px] hover:bg-[#EDEEF4] py-2 px-5 cursor-pointer">
                                        Call Now
                        ...
                        <div className="flex gap-1 items-center relative">
                            ...
                            {/* Create Lead Button */}
                            <button
                                onClick={() => navigate('/create-client-lead')}
                                // onClick={() => {
