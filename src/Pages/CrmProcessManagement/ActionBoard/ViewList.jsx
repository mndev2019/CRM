    ...
    return (
        <div className="relative w-[170px]">
            ...
            <div
                ...
                className="bg-white border border-[#EDEEF4] px-4 py-2 rounded-[6px]
                text-sm text-gray-700 cursor-pointer flex justify-between items-center"
            >
                ...
                <div className="rounded-[12px] border border-[#EDEEF4] p-3">
                    ...
                    <div className="flex items-center justify-between py-3">
                        <div className="flex items-center gap-3">
                            ...
                            <button onClick={() => setListType("All")} className="text-gray-700 text-[16px] font-light">
                                ✕
                            </button>

                            {/* CREATED BY FILTER */}
                            <CreatedByDropdown value={createdBy} onChange={setCreatedBy} />
                            <button onClick={() => setCreatedBy("")} className="text-gray-700 text-[16px] font-light">
                                ✕
                            </button>
                        </div>
