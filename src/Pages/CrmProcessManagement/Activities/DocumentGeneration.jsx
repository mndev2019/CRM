              ...
              {showDotsMenu && (
                <div className="bg-white absolute top-12 right-0 rounded-[4px] shadow z-20 w-48">
                  ...
                  <p
                    ...
                    className="nunito flex items-center gap-2 font-semibold text-[14px] hover:bg-[#EDEEF4] py-2 px-4 cursor-pointer"
                  >
                    <TbFileExport size={22} /> Export Lead Docs Activity
                  </p>
                </div>
              )}
            </div>
              ...
              <tbody>
                {[
                  ...
                  >
                    ...
                    <td className="p-3">
                      <span
                        className={`px-3 py-1 rounded-[6px] font-semibold ${statusClasses[item.Status]}`}
                      >
                        {item.Status}
                      </span>
                    </td>
