...
const ShowSalesActivity = () => {
  ...
  const statusClasses = {
    Open: "bg-[#DCEBFF] text-[#1A73E8]",
    Won: "bg-[#EFFFF0] text-[#049B1D]",
          ...
          <div className="flex flex-col md:flex-row md:justify-between gap-4 py-2 border-b-2 border-[#EDEEF4]">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              <button
                ...
                className="border-[#8693FF] border hover:bg-[#7785f5] hover:text-white transition text-[#8693FF] nunito font-semibold text-[15px] rounded-md py-2 px-4 shadow-sm"
              >
                Sales Activity
              </button>
