...
const PendingLead = () => {
    ...
    //check leadsstage === pending processing
    const engagedLeads = data.filter(item =>
        ["pending", "processing"].includes(item.leadStage?.toLowerCase())
    );
    /* ================= SEARCH FILTER ================= */
    const filteredData = engagedLeads.filter((item) =>
