...
const ShowAutomation = () => {
    ...
    return (
        <>
            <Topnav
                title="Automation"
                subtitle="Create and manage automated workflows to streamline your lead management process."
                icon={automation}
            />
            <section className='p-4 bg-white rounded-bl-2xl rounded-br-2xl'>
                <div className=" border border-[#EDEEF4] rounded-[12px] bg-white">
                    ...
                    <div className="flex items-center justify-between mb-4 p-4">
                        ...
                        {/* Button */}
                        <button onClick={() => navigate('/create-automation')} className="text-white font-semibold px-4 py-2 rounded-md cursor-pointer
                    ...
                    <div className="flex  gap-10 text-sm text-gray-700  border-t border-[#EDEEF4] bg-[#F8F9FB] p-4">
                        ...
                        <div className="relative w-[250px] flex gap-2">
                            <label className='inter font-500 text-[16px] text-[#363636]'>MofidiedBy</label>
                            <select
                                className="w-full appearance-none bg-transparent 
                                            border-0 border-b border-[#D0D5DD] 
                                            pb-1 pr-6 text-sm text-gray-600 
                        ...
                        <table className="w-full text-sm">
                            ...
                            <thead className="bg-[#EAF6FF] inter *:text-[15px]">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 text-left">Trigger Count</th>
